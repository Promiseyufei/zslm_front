          ...
          <el-table :data="tableData3"  border style="width: 100%" :header-cell-style="getRowClass">
            <el-table-column
              ...
              <template slot-scope="scope" >
                  <el-input v-model="tableData3[scope.$index].weight" @focus="focusCount(tableData3[scope.$index].weight)" v-on:blur="changeCount(tableData3[scope.$index].weight, scope.$index)"></el-input>
              </template>
            </el-table-column>
            <el-table-column
              :prop="list.prop"
