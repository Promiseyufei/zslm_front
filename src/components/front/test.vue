    ...
    <div>
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 c-column column_AfewZV">
            ...
            <div class="c-div div_0oZzVH xiangqingye">
                ...
                <p class="c-paragraph heading_58QPWV bold">北京市海淀区学院南路39号招生推广部北二平房A05室</p>
            </div>
            <div class="c-div div_0oZzVH xiangqingye">
                <div class="c-div div_eQPG16">
                ...
                <p class="c-paragraph heading_58QPWV bold">2018.7.2  08:00至2018.8.22  17:00</p>
            </div>
            <div class="c-div div_0oZzVH xiangqingye last">
                ...
                <h1 class="c-heading heading_V5QM03">招生宣讲</h1>
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 c-column column_MgrNOl">
            <a class="btn c-button button_LsM2yn123 quguan" type="button">快速报名</a>
        </div>
    </div>
</template>
