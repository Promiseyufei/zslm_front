        ...
        <div class="publicRowbox">
            ...
            <div class="publicRow">
                ...
                <nav class="publicRowRight" style="">
                    <div ref="publiccheckbox">
                        <el-checkbox :indeterminate="isIndeterminate[0]" v-model="checkAll[0]"
                                     @change="handleCheckAllChange(0)" :class="checkboxGroup[0]==''?'ff':'' ">全部
                        </el-checkbox>
                        <el-radio-group v-model="checkboxGroup[0]" @change="handleChange">

                            <el-radio-button v-for="(city,ind) in list[0].cities" :label="city" :key="ind">
                                {{city.name}}
                            </el-radio-button>
                        </el-radio-group>
                    </div>
            ...
            <div class="publicRow">
                ...
                <nav class="publicRowRight">
                    <div ref="publiccheckbox">
                        <el-checkbox :indeterminate="isIndeterminate[1]" v-model="checkAll[1]"
                                     @change="handleCheckAllChange(1)" :class="checkboxGroup[1]==''?'ff':'' ">全部
                        </el-checkbox>
                        <el-checkbox-group v-model="checkboxGroup[1]" @change="handleChange">

                            <el-checkbox-button v-for="(city,ind) in list[1].cities" :label="city" :key="ind">
                                {{city.name}}
                            </el-checkbox-button>
                        </el-checkbox-group>
                    </div>
            ...
            <div class="publicRow">
                ...
                <nav class="publicRowRight">
                    <div ref="publiccheckbox">
                        <el-checkbox :indeterminate="isIndeterminate[2]" v-model="checkAll[2]"
                                     @change="handleCheckAllChange(2)" :class="checkboxGroup[2]==''?'ff':'' ">全部
                        </el-checkbox>
                        <el-checkbox-group v-model="checkboxGroup[2]" @change="handleChange">

                            <el-checkbox-button v-for="(city,ind) in list[2].cities" :label="city" :key="ind">
                                {{city.name}}
                            </el-checkbox-button>
                        </el-checkbox-group>
                    </div>
