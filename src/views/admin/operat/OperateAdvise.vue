				...
				<div>
					...
					<div class="operateUpfiles operateDown">
						...
						<div class="operateUpfilesRight2">
							...
							<!-- 表格 -->
							<AdviseTable1 :tableData3="tableData3" :listTable="listTable" @setInfoRelation="setOpAd" @del="delAdvise"
							 @showPage="showPage"></AdviseTable1>
							<!-- 完成按钮 -->
		...
		methods: {
			...
			showPage: function(id) {
				let routeUrl = this.$router.resolve({
					path: "/front/firstMenuRouter/viewInformation/singleInformation/" + id,
