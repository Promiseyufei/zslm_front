                            ...
                            <el-form ref="ruleForm" :model="ruleForm" label-width="100px">
                              ...
                              <el-form-item label="活动类型">
                                <el-checkbox-group v-model="ruleForm.type" :disabled = "disabled">
                                  <el-checkbox label="提前面试" name="type"></el-checkbox>
                                  <el-checkbox label="招生宣讲" name="type"></el-checkbox>
                                  <el-checkbox label="高精会议" name="type"></el-checkbox>
                                  <el-checkbox label="讲座论坛" name="type"></el-checkbox>
                                </el-checkbox-group>
                              </el-form-item>
                              ...
                              <el-form-item label="专业类型">
                                <el-checkbox-group v-model="ruleForm.spaticalType" :disabled = "disabled">
                              ...
                              <el-form-item label="开始时间">
                                <el-select v-model="ruleForm.startTime" placeholder="请选择活动区域" :disabled = "disabled">
                                  <el-option label="2" value="2"></el-option>
                                  <el-option label="3" value="3"></el-option>
                                </el-select>
                              </el-form-item>
                              <el-form-item label="结束时间">
                                <el-select v-model="ruleForm.endTime" placeholder="请选择活动区域" :disabled = "disabled">
                                  <el-option label="2" value="2"></el-option>
                                  <el-option label="3" value="3"></el-option>
                                </el-select>
                              </el-form-item>
