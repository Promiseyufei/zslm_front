			...
			<div class="row c-row row_lysUBI">
				<div class="col-lg-2_4 col-md-2_4 col-sm-2_4 col-xs-12 c-column column_mGHURg">
					<div class="c-div div_jvE6kN">
						...
						<h1 class="c-heading heading_wT39zy">领取优惠券</h1>
					</div>
				</div>
				<div class="col-lg-2_4 col-md-2_4 col-sm-2_4 col-xs-12 c-column column_mGHURg">
					<div class="c-div div_jvE6kN">
						...
						<h1 class="c-heading heading_bzBLAm">step.2</h1>
						<h1 class="c-heading heading_wT39zy">在个人中心可以查看到相应的优惠券</h1>
					</div>
				</div>
				<div class="col-lg-2_4 col-md-2_4 col-sm-2_4 col-xs-12 c-column column_mGHURg">
					<div class="c-div div_jvE6kN">
						...
						<h1 class="c-heading heading_bzBLAm">step.3</h1>
						<h1 class="c-heading heading_wT39zy">选择想要使用的优惠券，点击使用</h1>
					</div>
				</div>
				<div class="col-lg-2_4 col-md-2_4 col-sm-2_4 col-xs-12 c-column column_mGHURg">
					<div class="c-div div_jvE6kN">
				...
				<div class="col-lg-2_4 col-md-2_4 col-sm-2_4 col-xs-12 c-column column_mGHURg">
					<div class="c-div div_jvE6kN">
						...
						<h1 class="c-heading heading_bzBLAm">step.5</h1>
						<h1 class="c-heading heading_wT39zy">在辅导机构报名时，出示短信凭据即可享受优惠</h1>
					</div>
				</div>
			</div>
		</div>
