		...
		<div class="container-fluid c-section section_bUBpNL">
			<div class="row c-row row_EaN5GL">
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 c-column column_Pmqzmn" style="margin-bottom: 25px">
					<userInfomation :user_name="this.userName" :colleges="this.userCollege" :provices="this.userProvice" :citys="this.userCity"
					 :actives="this.userActive" :ding="this.userNews" :coupons="this.userCoupon" :userhead="this.userHead"></userInfomation>
					<userList></userList>
